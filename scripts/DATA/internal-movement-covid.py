...
with open('../data/internal-movement-covid.csv') as f:
    p = pd.read_csv(f)

with open('../data/internal-movement-covid.txt', 'w') as f:
    ...
    f.writelines("The policies shown may not apply at all sub-national levels. A country is coded as having these restrictions if at least some sub-national regions have implemented them.")
